  ...
  return (
    <div className="backside-view">
      ...
      <p style={{ color: '#666', marginBottom: '20px' }}>
        ローカルの JSON データに基づくリソース管理画面へ移動します。
      </p>

      <div
        className="backside-menu"
        style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '40px' }}
      >
        <button
          className="action-btn"
          style={{ padding: '16px', fontSize: '1.1rem', textAlign: 'left' }}
          onClick={() => onCommand?.('/pantry')}
        >
          🍎 食材・調味料の管理 (/pantry)
        </button>
        <button
