  ...
  return (
    ...
    >
      <input
        {...rest}
        ref={ref}
        style={{ ...rest.style, paddingRight: '30px', boxSizing: 'border-box' }}
      />
...
export function AddView() {
  ...
  const handleExpiresBlur = () => {
    ...
    if (/^\d{8}$/.test(ingExpires)) {
      setIngExpires(
        `${ingExpires.slice(0, 4)}-${ingExpires.slice(4, 6)}-${ingExpires.slice(6, 8)}`
      );
    }
  };
  ...
  return (
    <div
      ...
      style={{ padding: '20px', overflowY: 'auto', flex: 1, position: 'relative' }}
    >
      <div
        style={{
          position: 'absolute',
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '20px' }}>
        <button
          ...
          style={{
            ...
            cursor: 'pointer',
            background: activeTab === 'ingredient' ? '#4caf50' : '#fff',
            color: activeTab === 'ingredient' ? '#fff' : '#333',
          }}
        >
          食材を追加
        </button>
        <button
          ...
          style={{
            ...
            border: '1px solid #ccc',
            cursor: 'pointer',
            background: activeTab === 'seasoning' ? '#2196f3' : '#fff',
            color: activeTab === 'seasoning' ? '#fff' : '#333',
          }}
        >
          調味料を追加
        </button>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <ClearableInput
                ...
                value={ingQuantity}
                onChange={(e) =>
                  setIngQuantity(e.target.value === '' ? '' : Number(e.target.value))
                }
                onClear={() => setIngQuantity('')}
                min="0"
                step={ingUnit === 'g' || ingUnit === 'ml' ? '10' : '0.1'}
                style={{ width: '100%', padding: '10px', fontSize: '1.1rem' }}
              />
              <div style={{ display: 'flex', gap: '4px', marginTop: '8px' }}>
                {ingUnit === 'g' || ingUnit === 'ml' ? (
                  <>
                    <button
                      type="button"
                      onClick={() => addQuantity(setIngQuantity, 10)}
                      style={{
                        padding: '4px 8px',
                        borderRadius: '4px',
                        border: '1px solid #ccc',
                    ...
                    <button
                      type="button"
                      onClick={() => addQuantity(setIngQuantity, 50)}
                      style={{
                        padding: '4px 8px',
                        borderRadius: '4px',
                        border: '1px solid #ccc',
                    ...
                    <button
                      type="button"
                      onClick={() => addQuantity(setIngQuantity, 100)}
                      style={{
                        padding: '4px 8px',
                        borderRadius: '4px',
                        border: '1px solid #ccc',
                  ...
                  <>
                    <button
                      type="button"
                      onClick={() => addQuantity(setIngQuantity, 1)}
                      style={{
                        padding: '4px 8px',
                        borderRadius: '4px',
                        border: '1px solid #ccc',
                    ...
                    <button
                      type="button"
                      onClick={() => addQuantity(setIngQuantity, 5)}
                      style={{
                        padding: '4px 8px',
                        borderRadius: '4px',
                        border: '1px solid #ccc',
          ...
          <div>
            ...
            <ClearableInput
              type="text"
              value={ingExpires}
              onChange={(e) => setIngExpires(e.target.value)}
              onBlur={handleExpiresBlur}
              onClear={() => setIngExpires('')}
          ...
          <button
            type="submit"
            disabled={!ingName.trim() || saveStatus === 'saving'}
            style={{
              padding: '14px',
              marginTop: '10px',
              background: '#4caf50',
              ...
              borderRadius: '4px',
              fontSize: '1.1rem',
              cursor: !ingName.trim() ? 'not-allowed' : 'pointer',
              fontWeight: 'bold',
            }}
          >
            追加して次へ入力
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <ClearableInput
                type="number"
                value={seaAmount}
                onChange={(e) => setSeaAmount(e.target.value === '' ? '' : Number(e.target.value))}
                onClear={() => setSeaAmount('')}
                min="0"
                style={{ width: '100%', padding: '10px', fontSize: '1.1rem' }}
              />
              <div style={{ display: 'flex', gap: '4px', marginTop: '8px' }}>
                <button
                  type="button"
                  onClick={() => addQuantity(setSeaAmount, 10)}
                  style={{
                    padding: '4px 8px',
                    borderRadius: '4px',
                    border: '1px solid #ccc',
                ...
                <button
                  type="button"
                  onClick={() => addQuantity(setSeaAmount, 50)}
                  style={{
                    padding: '4px 8px',
                    borderRadius: '4px',
                    border: '1px solid #ccc',
                ...
                <button
                  type="button"
                  onClick={() => addQuantity(setSeaAmount, 100)}
                  style={{
                    padding: '4px 8px',
                    borderRadius: '4px',
                    border: '1px solid #ccc',
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <ClearableInput
                ...
                value={seaAmountFull}
                onChange={(e) =>
                  setSeaAmountFull(e.target.value === '' ? '' : Number(e.target.value))
                }
                onClear={() => setSeaAmountFull('')}
                min="1"
                style={{ width: '100%', padding: '10px', fontSize: '1.1rem' }}
              />
              <div style={{ display: 'flex', gap: '4px', marginTop: '8px' }}>
                <button
                  type="button"
                  onClick={() => addQuantity(setSeaAmountFull, 10)}
                  style={{
                    padding: '4px 8px',
                    borderRadius: '4px',
                    border: '1px solid #ccc',
                ...
                <button
                  type="button"
                  onClick={() => addQuantity(setSeaAmountFull, 50)}
                  style={{
                    padding: '4px 8px',
                    borderRadius: '4px',
                    border: '1px solid #ccc',
                ...
                <button
                  type="button"
                  onClick={() => addQuantity(setSeaAmountFull, 100)}
                  style={{
                    padding: '4px 8px',
                    borderRadius: '4px',
                    border: '1px solid #ccc',
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <select
                value={seaUnit}
                onChange={(e) => setSeaUnit(e.target.value as 'ml' | 'g')}
                style={{
                  width: '100%',
                  padding: '10px',
          ...
          <div>
            ...
            <ClearableInput
              type="text"
              value={seaNote}
              onChange={(e) => setSeaNote(e.target.value)}
              onClear={() => setSeaNote('')}
              placeholder="特記事項があれば"
              style={{ width: '100%', padding: '10px', fontSize: '1.1rem' }}
            />
          ...
          <button
            type="submit"
            disabled={!seaName.trim() || saveStatus === 'saving'}
            style={{
              padding: '14px',
              marginTop: '10px',
              background: '#2196f3',
              ...
              borderRadius: '4px',
              fontSize: '1.1rem',
              cursor: !seaName.trim() ? 'not-allowed' : 'pointer',
              fontWeight: 'bold',
            }}
          >
            追加して次へ入力
